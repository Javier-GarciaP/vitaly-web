          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              ...
              <div className="relative">
                <input name="fibrinogeno" type="text" value={resultados?.fibrinogeno || ""} onChange={(e) => handleChange("fibrinogeno", e.target.value)} className={`${inputBase} bg-rose-50 border-rose-100 focus:border-rose-400`} placeholder="200 - 400" />
              </div>
            </div>
          </div>
        </div>
