export const MIGRATIONS = [
  // 1.sql: Tabla Pacientes
  `CREATE TABLE IF NOT EXISTS pacientes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    cedula TEXT NOT NULL UNIQUE,
    nombre TEXT NOT NULL,
    edad TEXT, -- Updated to TEXT as per 11.1.sql
    sexo TEXT,
  ...
  // 4.sql: Tabla Examenes Predefinidos
  ...
  // 5.sql: Tabla Plantillas Miscelaneos
  ...
  // 6.sql: Tabla Plantillas Bacteriologia
  ...
  // 10.sql: Update Hematology
  `DELETE FROM hematologia_valores_referencia WHERE nombre_examen = 'Hemoglobina';
  INSERT OR IGNORE INTO hematologia_valores_referencia (nombre_examen, valor_referencia) VALUES
  ...
  // 12.sql: Update Examenes Predefinidos
  ...
  // 14.sql: Make cedula and edad optional
